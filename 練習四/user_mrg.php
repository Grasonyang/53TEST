...
<body>
    ...
    <button type="button" onclick="location.href='mrg.php'">會員管理</button>
    <button type="button" onclick="location.href='onshop.php?call=1'">上架商品</button>
            ...
            success:function(e){
                ...
                for(let i=0;i<list.length;i++){
                    ...
                    $("body").append(`
                        ...
                        <button type="button" class="safawf" onclick="location.href='onshop.php?call=0&id=${arr['id']}'">修改</button>
                    `);
                    $(".row"+i+" .timg").text("");
                    $(".row"+i+" .timg").append(`
                        <img src="${arr['img']}">
